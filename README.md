...
This project enables the generation of audio stories, adaptable to various themes. The example code focuses on German superhero tales for children. It utilizes OpenAI's GPT models for crafting stories which are then converted into audio format. Stories have a length from 5 - 15 minutes and contain 5 chapters.
